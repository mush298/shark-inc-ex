const FORGE = {
    ...
    drill: {
        ...
        time: [1500, 3000, 6000, 9000, 30000, 60000, 2e8, 1e46],
        cost: [
            [
                ['stone',1e47],
                ['bismuth',5e3],
    ...
    shard: {
        ...
        time: [1500,3000,6000,18000,1e46],
        cost: [
            [
                ['prestige','ee50',true],
                ['bismuth',5e3],
    ...
    refined_shard: {
        ...
        time: [60000, 2e8, 3e10, 1e46,1e49,1e71],
        cost: [
            [
    ...
    matter: {
        ...
        time: [1e43,1e46,1e52,1e67,1e189,1],
        cost: [
            [
                ['remnants',1e135],
                ['radium',100],
